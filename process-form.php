...
$sql ="INSERT INTO feedback ( fname, email, mobile, pnr_no, classes, enjoyment, bookingEase, bookingprob, restroom, punctuality, communication, serviceissues, userexperience, suggestion)
                      VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)";
